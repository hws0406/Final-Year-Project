                                                    ...
                                                    if ($query->rowCount() > 0) {
                                                        foreach ($results as $result) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="useredit-result.php?stid=<?php echo htmlentities($result->StudentId);?>"><i class="fa fa-edit" title="Edit Record"></i></a>
                                                                </td>
                                                            </tr>
                                                            <?php
                                                            $cnt++;
    ...
    $(function ($) {
        ...
        $('#filterBtn').click(function() {
            ...
            if (formFilter !== '' || classFilter !== '') {
                var url = 'usermanage-results.php?';
        ...
        $('#resetBtn').click(function() {
            ...
            window.location.href = 'usermanage-results.php';
        });
        ...
        $('.delete').click(function () {
            ...
            if (confirm('Are you sure you want to delete this record?')) {
                ...
                window.location.href = 'userdelete-result.php?stid=' + studentId;
            }
        });
    });
    </script>
