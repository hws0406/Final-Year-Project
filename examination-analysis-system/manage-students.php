                                                        ...
                                                        foreach ($results as $result) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="manage-students.php?stid=<?php echo htmlentities($result->StudentId); ?>" onclick="return confirm('Are you sure you want to delete this student?');"><i class="fa fa-trash" title="Delete Record"></i></a>
                                                                </td>
                                                            </tr>
                                                    <?php
                                                            $cnt++;
